...
nohup /root/spark/bin/pyspark --master $MASTER --packages com.databricks:spark-csv_2.10:1.1.0,com.databricks:spark-avro_2.10:2.0.1 --total-executor-cores 24  --executor-memory 14024m >> /var/log/python_notebook.log &
